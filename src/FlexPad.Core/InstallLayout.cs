...
public static class InstallLayout
{
    ...
    /// <c>%LOCALAPPDATA%\Programs\FlexPad</c>. Human-readable rather than RID-suffixed, matching
    /// the convention the other station tools use.
    /// </summary>
    public const string ProductFolder = "FlexPad";
    ...
    /// </summary>
    public const string ProductFolderUnix = "flexpad";
    ...
    /// copies ended up in <c>FlexPad-win-x64</c> before there was an installer — including the one
    ...
    /// <c>%LOCALAPPDATA%\Programs</c> yields <c>%LOCALAPPDATA%\Programs\FlexPad</c>.
    /// </summary>
